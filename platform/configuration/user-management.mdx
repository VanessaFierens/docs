...
description: Invite members by email, assign workspace roles, deactivate or reactivate accounts, and bulk-import users via CSV from the Settings Users page.
---
