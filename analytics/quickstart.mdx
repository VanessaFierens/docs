...
description: Connect a data source, create a dashboard, add your first chart, and share it with teammates. A step-by-step quickstart for new analytics users.
---
...
- Explore the charts and visualizations reference to learn about all available chart types.
