---
title: Product guide — Platform, Analytics, and Integrations
description: Set up your workspace, build dashboards, and connect integrations. Browse guides for Platform configuration, Analytics reporting, and Integrations setup.
mode: frame
---
