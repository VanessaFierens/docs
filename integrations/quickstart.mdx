---
title: Integrations quickstart — connect your first tool
sidebarTitle: Quickstart
description: Connect your first integration from the catalog in under 10 minutes. Authenticate, map fields, and run a test sync to validate the connection.
---
