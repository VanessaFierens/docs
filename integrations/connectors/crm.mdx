---
title: CRM connectors — Salesforce, HubSpot, and more
description: Connect Salesforce, HubSpot, Pipedrive, Zoho, or Dynamics 365 to sync contacts, deals, and activity. Configure field mapping and sync intervals.
---
