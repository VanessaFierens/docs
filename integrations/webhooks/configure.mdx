...
description: Register an HTTPS endpoint, subscribe to events, verify the X-Signature-256 HMAC header, and send test payloads to validate webhook delivery.
---
...
<Steps>
  ...
  <Step title="Select events">
    ...
    {/* TODO: link target /integrations/webhooks/event-types does not exist yet. */}
    Refer to the event types reference for the full list and payload schemas.
  </Step>
